...
'Gama':['Santa Maria', 'Recanto das Emas', 'Riacho Fundo II', 'Park Way']
...
'Samambaia':['Ceilândia', 'Taguatinga', 'Riacho Fundo', 'Riacho Fundo II']
'Santa Maria':['São Sebastião', 'Gama', 'Lago Sul', 'Park Way']
'São Sebastião':['Paranoá', 'Jardim Botânico', 'Lago Sul', 'Santa Maria']
'Recanto das Emas':['Samambaia', 'Gama', 'Riacho Fundo II']
...
'Candangolândia':['Guará','Plano Piloro', 'Lago Sul']
'Águas Claras':['Taguatinga', 'Guará', 'Núcleo Bandeirante', 'Riacho Fundo']
'Riacho Fundo II':['Gama', 'Recanto das Emas', 'Samambaia', 'Riacho Fundo', 'Park Way']
'Sudoeste':['SIA', 'Plano Piloto', 'Cruzeiro']
'Varjão':['Plano Piloto', 'Lago Norte']
'Park Way':['Gama', 'Riacho Fundo II', 'Riacho Fundo', 'Núcleo Bandeirante', 'Lago Sul', 'Santa Maria', 'Jardim Botânico', 'São Sebastião']
